...
# Horizontal angle ranges for bunts, inxed [contactType][unusedIndex (ommitted)] -> [low, high].
BuntingAngleRanges = [[256, 960], [480, 640], [512, 576], [480, 640], [256, 960]]
...
# Bunt vertical ranges, indexed [contactType][randomBool] -> [low, high].
BuntingVerticalAngleRanges = [[[-256, 960], [-256, 960]], [[-96, 64], [-96, 96]], [[-64, 32], [-64, 32]], [[-96, 64], [-96, 96]], [[-256, 960], [-256, 960]]]

# Bunt power ranges, indexed [contactType] -> [low, high].
BuntHitPowerRanges = [[20, 50], [45, 60], [30, 45], [45, 60], [20, 50]]
